...
public class GroupCommand implements CommandClass {
    ...
    @CommandFramework.Command(name = "groupset", usage = "/<command> <player> <group>", groupToUse = Group.ADMIN,
    ...
    @CommandFramework.Command(name = "permission", usage = "/<command> <player> <group>", groupToUse = Group.ADMIN, runAsync = true)
    ...
    @CommandFramework.Command(name = "addmedal", groupToUse = Group.ADMIN, runAsync = true)
    ...
    @CommandFramework.Command(name = "givevip", usage = "/<command> <player> <tempo> <group>", groupToUse = Group.ADMIN,
    ...
    @CommandFramework.Command(name = "removevip", usage = "/<command> <player> <group>", groupToUse = Group.ADMIN,
             aliases = {"removervip"})
