...
import br.com.pentamc.common.clan.ClanInvite;
import br.com.pentamc.common.clan.ClanModel;
import br.com.pentamc.common.clan.ClanVoid;
...
public class ClanCommand implements CommandClass {
	...
	@CommandFramework.Command(name = "clanchat", aliases = { "cchat" })
	...
	@CommandFramework.Command(name = "clan.top")
