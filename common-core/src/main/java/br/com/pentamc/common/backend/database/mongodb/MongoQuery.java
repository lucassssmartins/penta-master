package br.com.pentamc.common.backend.database.mongodb;
...
public class MongoQuery implements Query<JsonElement> {
	...
	public Collection<JsonElement> find() {
		...
		while (mongoCursor.hasNext())
			documentList.add(new JsonParser().parse(mongoCursor.next().toJson(SETTINGS)));
	...
	public <GenericType> JsonElement findOne(String key, GenericType value) {
		...
		if (document != null)
			json = new JsonParser().parse(document.toJson(SETTINGS));
