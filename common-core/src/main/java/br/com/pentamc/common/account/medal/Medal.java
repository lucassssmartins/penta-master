package br.com.pentamc.common.account.medal;
...
public enum Medal {
	...
	TOXIC("Tóxico", "blalalblad", MedalRarity.COMMON, ChatColor.YELLOW,
			'☣'),
	UPSET_HEART("Coração Chateado", "blalalblad", MedalRarity.COMMON, ChatColor.DARK_RED,
			'❥'),
	SMILE("Sorriso", "blalalblad", MedalRarity.COMMON, ChatColor.YELLOW,
			'ツ'),
	MUSIC("Músico", "blalalblad", MedalRarity.COMMON, ChatColor.DARK_PURPLE,
			'♫'),
	SKELETON("Crânio de Esqueleto", "blalalblad", MedalRarity.COMMON, ChatColor.GRAY,
			'☠'),
	UMBRELLA("Guarda Chuva", "blalalblad", MedalRarity.COMMON, ChatColor.GRAY,
			'☠'),
