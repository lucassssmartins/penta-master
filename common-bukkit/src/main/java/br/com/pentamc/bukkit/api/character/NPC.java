...
import br.com.pentamc.bukkit.utils.EntityUtils;
	...
	private static String[] getSkin(String name) {
		try {
			JsonObject jsonObject = CommonConst.DEFAULT_WEB
					.doRequest("https://api.mojang.com/users/profiles/minecraft/" + name, WebHelper.Method.GET).getAsJsonObject();
